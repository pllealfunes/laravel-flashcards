describe("User login and delete a group while the decks remain", () => {
    ...
    it("Can successfully delete a group", () => {
        cy.get('[data-testid="delete-all-modal"]').first().click();
        // Ensure the modal is open
        cy.contains(
            "Are you sure you want to delete this group and all decks?"
        ).should("be.visible");

        cy.contains("Are you sure you want to delete this group and all decks?")
