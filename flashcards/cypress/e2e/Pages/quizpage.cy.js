describe("User login and update group", () => {
    ...
    it("should take me to the quiz page and display questions", () => {
        cy.get('[data-testid="quiz-btn"]').click();
        cy.get('[data-testid="quiz-question"]').first();
        cy.get('[data-testid="submit-quiz-btn"]');
    });
});
